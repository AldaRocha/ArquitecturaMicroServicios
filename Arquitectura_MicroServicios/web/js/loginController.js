...
/* 
    Created on : 21 sep. 2024, 17:56:24
    Author     : Alda
*/
...
function ingresar(){
    ...
    encriptar(contrasenia)
            .then((textoEncriptado)=>{
                let datos=JSON.stringify({Cuenta: usuario, Contrasena: textoEncriptado.toString()});
                            ...
                            return response.json();
                                ...
                                .then(data=>{
                                    ...
                                    if(data.error){
                                        ...
                                        Swal.fire('', "Bienvenido "+data.Persona.Nombre, 'success');
